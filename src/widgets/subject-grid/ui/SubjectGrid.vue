...
<template>
  <div>
    <div class="hero">
      <p class="eyebrow">GTA 5 RP · осенний ивент</p>
      <h1>Шпаргалки к экзаменам в универе</h1>
      <p class="lead">
        Разборы заданий университетского ивента: все рецепты химии и решатель для взлома
        терминала в информатике. С 1 сентября открывается по одному предмету в день, новый
        день наступает в {{ DAY_STARTS_AT_HOUR }}:00 по Москве. Номер слева — день: 01 —
        первое число, 02 — второе, и так до десятого.
      </p>
