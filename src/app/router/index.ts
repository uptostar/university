  ...
  routes: [
    {
      ...
      meta: {
        ...
        description:
          ...
          'и цепочками крафта, решатель для взлома терминала в информатике и таблица знаков ' +
          'для эпиграфики в истории. Предметы открываются по одному в день с 1 сентября.',
      },
    },
    {
      path: '/chem',
    ...
    },
    {
      path: '/hist',
      name: 'history',
      component: () => import('@/pages/history').then((m) => m.HistoryPage),
      meta: {
        title: 'История: эпиграфика, таблицы знаков и перевод — ивент GTA 5 RP',
        description:
          'Помощник для задания по истории в осеннем ивенте GTA 5 RolePlay. Все таблицы ' +
          'знаков под рукой — «Стена храма», «Славянский устав» и «Камни-рунницы»: жмёшь ' +
