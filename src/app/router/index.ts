  ...
  routes: [
    ...
    },
    {
      ...
      meta: {
        ...
        description:
          'Помощник для задания по истории в осеннем ивенте GTA 5 RolePlay. Обе таблицы ' +
          'знаков под рукой — египетская «Стена храма» и «Славянский устав»: жмёшь знаки ' +
          'в том порядке, в каком они на стене, и перевод собирается сам.',
      },
    },
